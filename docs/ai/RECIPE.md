# iOS transcription widget

## Overview

Add a live transcription widget to an iOS RTC app for captions during audio/video calls.

Use this recipe when you want a working reference for iOS widget, RTC audio, live captions, transcription.

Repository: [AgoraIO-Community/TranscriptionWidget-iOS](https://github.com/AgoraIO-Community/TranscriptionWidget-iOS)
...
```text
You are working in `AgoraIO-Community/TranscriptionWidget-iOS`. Add or adapt this sample so a developer can run the ios transcription widget end to end with Agora RTC.
